...
def show_go_screen():
  ...
  draw_text( "Press a key to begin", 18, vari.WIDTH / 2, vari.HEIGHT * 3 / 4)
  pygame.display.flip()
  waiting = True
...
while running:
    ...
    collide = pygame.sprite.spritecollide(playerthing, ballgroup, False) 
    if collide:
      game_over = True
    ...
    score = float(score)
    if score % 100 == 0:
      draw_text(f"Who who {score} this is meant to distract you.", 20, vari.WIDTH/2, 50)
